...
class GameQuestion < ActiveRecord::Base
  ...
  # Новый для нас метод, который говорит: если вызвать у объекта GameQuestion
  # методы text или level, то их надо делегировать связанному
  # объекту Question, то есть фактически дёрнуть эти методы
  # у Question
